...
function GuideSidebar() {
  return (
    <nav className="sidebar">
      ...
      <a className="sb-link" href="#s141">
        {"Functions of Several Variables"}
      </a>
      <a className="sb-link" href="#s142">
        {"Limits & Continuity"}
      </a>
      <a className="sb-link" href="#s143">
        {"Partial Derivatives"}
      </a>
      <a className="sb-link" href="#s144">
        {"The Chain Rule"}
      </a>
      <a className="sb-link" href="#s145">
        {"Directional Derivatives"}
      </a>
      <a className="sb-link" href="#s146">
        {"Tangent Planes & Differentials"}
      </a>
      <a className="sb-link" href="#s147">
        {"Extreme Values"}
      </a>
      <div className="sb-group">
        {"Reference"}
      </div>
      <a className="sb-link" href="#summary">
        <span className="sn">
          {"\u2014"}
        </span>
        {"Key Formulas"}
  ...
  return (
    <nav className="toc">
      ...
      <div className="toc-grid">
        <a className="toc-a" href="#s141">
          {"Functions of Several Variables"}
        </a>
        <a className="toc-a" href="#s145">
          {"Directional Derivatives & Gradient"}
        </a>
        <a className="toc-a" href="#s142">
          {"Limits and Continuity"}
        </a>
        <a className="toc-a" href="#s146">
          {"Tangent Planes & Differentials"}
        </a>
        <a className="toc-a" href="#s143">
          {"Partial Derivatives"}
        </a>
        <a className="toc-a" href="#s147">
          {"Extreme Values & Saddle Points"}
        </a>
        <a className="toc-a" href="#s144">
          {"The Chain Rule"}
        </a>
        <a className="toc-a" href="#summary">
          <span className="tn">
            {"\u2014"}
          </span>
